...
<div class="container">
    ...
    <form method="post" class="editor-form">
        ...
        <div class="form-group">
            ...
            <input type="url" id="featured_image" name="featured_image" value="<?= e($_POST['featured_image'] ?? '') ?>" placeholder="https://...">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label><input type="checkbox" name="is_published" value="1" <?= isset($_POST['is_published']) ? 'checked' : '' ?>> מפורסם</label>
        </div>
